...
<body>
	<div class="container">
		<div class="col-sm-12">
			<h1 class="text-center text-info">SỬA DANH MỤC SẢN PHẨM</h1>
		</div>
	</div>
                    ...
                    @include('errors.note')
                        ...
                        <form role="form" enctype="multipart/form-data" name="frm_addUser" method="POST" class="container-fluid">
                            <div class="form-group">
                                ...
                                <input type="text" name="cate_name" class="form-control" id="addTitleNews" placeholder="Nhập tên danh mục ..." value="{{$cate->cate_name}}">
                            </div>
                            <div class="form-group text-center col-sm-12">
                                <button type="submit" name="add" id="btnAdd" class="btn btn-success">Sửa</button>
                                <a href="{{asset('admin/category')}}" type="submit" name="" id="btnAdd" class="btn btn-success">Hủy bỏ</a>
                            </div>
                            {{csrf_field()}}
                        </form>
                        <!-- /.panel-body -->
