...
<body>
                        ...
                        <form role="form" name="frmLogin" method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input onkeyup="return checkLogin()" class="form-control" placeholder="Tài khoản" name="email" type="text"autofocus="" value="{{old('')}}">
                                   
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Mật khẩu" name="password" type="password" id="password" value="">
                                ...
                                <input id="btnSubmit"  type="submit" class="btn btn-lg btn-success btn-block" value="Đăng nhập">
                            </fieldset>
                             {{csrf_field()}}
                        </form>
                    </div>
    ...
    <script src="backen/dist/js/sb-admin-2.js"></script>
